...
import org.apache.clerezza.platform.security.auth.AuthenticationMethod;
...
public class UserLoginListener implements LoginListener{
	...
	@Override
	public void userLoggedIn(String userName, Class<? extends AuthenticationMethod> clazz) {
