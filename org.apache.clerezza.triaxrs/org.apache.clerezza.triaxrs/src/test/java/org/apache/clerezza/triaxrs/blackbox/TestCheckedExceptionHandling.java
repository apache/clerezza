...
import org.apache.clerezza.triaxrs.mock.*;
import org.apache.clerezza.triaxrs.testutils.HandlerCreator;
import org.wymiwyg.wrhapi.HandlerException;

public class TestCheckedExceptionHandling {
    ...
    public static class MyResource {
        ...
        @GET
        public void handleGet() throws MyException {
            throw exception;
        }
    }
...
//        assertTrue(methodInvokedForGet);
        ...
        assertTrue(handlerExceptionThrown);
    }
}
