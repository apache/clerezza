 ...
 *
 */
public class UserBundlePermission extends Permission {
	private final Logger logger = LoggerFactory.getLogger(UserBundlePermission.class);
	private String accountName;

	public UserBundlePermission(String accountName, String actions)  {
		super(accountName);
	...
	public boolean equals(Object obj) {
		...
		final UserBundlePermission other = (UserBundlePermission) obj;
