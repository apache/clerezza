...
public class PasswordUtil {
	...
	public static String convertPassword(String password) {
		try {
			...
			ResponseBuilder responseBuilder = javax.ws.rs.core.Response.status(
					javax.ws.rs.core.Response.Status.INTERNAL_SERVER_ERROR).entity(nsae.getMessage());
			throw new WebApplicationException(responseBuilder.build());
		} catch (UnsupportedEncodingException uee) {
			ResponseBuilder responseBuilder = javax.ws.rs.core.Response.status(
					javax.ws.rs.core.Response.Status.INTERNAL_SERVER_ERROR).entity(uee.getMessage());
			throw new WebApplicationException(responseBuilder.build());
		}
	}
}
